    ...
    <section className={styles.shell} data-smoke="agent-tool-cost-calculator">
      <div className={styles.controls}>
        ...
        <div className={styles.row}>
          <label className={styles.field}>
            ...
            <input
              ...
              onChange={(event) =>
                update("monthlyTasks", Number(event.target.value))
              }
            />
          </label>
          <label className={styles.field}>
        ...
        <div className={styles.selection}>
          ...
          <p>
            도구 호출량은 평균값으로 입력하고 실제 공급자 청구서와 비교하세요.
          </p>
        </div>
      </div>
      ...
      <aside className={styles.result} aria-live="polite">
        ...
        <p className={styles.caveat}>
          재시도, 캐시, 장기 컨텍스트 할증, 저장소·네트워크·세금과 공급자별
          할인은 제외합니다. 웹 검색과 코드 실행 기본 단가는 변경될 수 있습니다.
        </p>
