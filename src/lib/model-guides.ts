...
> = {
  OpenAI: {
    ...
    strengths: [
      "경제형부터 최상위 모델까지 단계가 명확함",
      "Batch와 캐시 가격 비교 가능",
      "멀티모달 제품 흐름에 적용 가능",
    ],
    caveats: [
      "도구 호출·검색·이미지 비용은 별도일 수 있음",
      "실제 프롬프트 평가 없이 모델명을 품질 보증으로 해석하지 않기",
    ],
  },
  Anthropic: {
    summary:
    ...
    strengths: [
      "대량 처리용 Haiku와 범용 Sonnet 구분",
      "프롬프트 캐시와 Batch 절감 시나리오 제공",
      "복잡한 작업용 상위 모델 비교 가능",
    ],
    caveats: [
      "프로모션 가격의 종료일 확인 필요",
      "긴 컨텍스트와 부가 기능 과금은 공식 문서 재확인 필요",
    ],
  },
  Google: {
    summary:
    ...
    caveats: [
      "입력 길이에 따라 단가 구간이 달라질 수 있음",
      "Preview 모델은 사양과 가격이 바뀔 수 있음",
    ],
  },
};
